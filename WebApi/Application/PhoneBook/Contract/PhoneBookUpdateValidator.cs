...
{
    public class PhoneBookUpdateValidator:AbstractValidator<PhoneBookUpdateRequest>
    {
        public PhoneBookUpdateValidator()
        {
			RuleFor(x => x.phoneBookID).NotEmpty().WithMessage("電話簿代碼不能為空!!");
