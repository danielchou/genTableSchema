...
{
    public class MessageSheetUpdateValidator:AbstractValidator<MessageSheetUpdateRequest>
    {
        public MessageSheetUpdateValidator()
        {
			RuleFor(x => x.messageSheetType).NotEmpty().WithMessage("訊息傳送頁籤類別不能為空!!");
