...
const apiUrlPrefix = '/api/MessageSheet';
...
export const fetchCreate = ({ commit }, data) => {
  /**
   * Request body:
   	* messageSheetType          :  String
	* messageSheetID            :  String
	* messageSheetName          :  String
...
export const fetchExportReport = ({ commit }, data) => {
  ...
  const { isEncrypt = false, pData = '', reportName = 'rptMessageSheet', jsonData = {} } = data;
