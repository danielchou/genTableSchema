      ...
      <q-form @submit="onSubmitForm" class="q-gutter-md">
        ...
        <q-card-section style="max-height: 50vh" class="scroll">
            ...
            <q-input
                class="col"
                type="text"
                v-model.trim="formData.funcName"
                label="功能名稱"
                lazy-rules
            ...
            <q-input
                class="col"
                type="text"
                v-model.trim="formData.parentFuncID"
                label="上層功能代碼"
                lazy-rules
                :rules="[useRequiredInput, (val) => useMaxLength(val, 20)]"
            />
            ...
            <q-input
                class="col"
                type="text"
                v-model.trim="formData.systemType"
                label="系統類別"
                lazy-rules
                :rules="[useRequiredInput, (val) => useMaxLength(val, 20)]"
            />
            ...
            <q-input
                class="col"
                type="text"
                v-model.trim="formData.displayOrder"
                label="顯示順序"
                lazy-rules
                :rules="[useRequiredInput, (val) => useMaxLength(val, )]"
            />
