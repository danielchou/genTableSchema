...
import messageSheet from '@supervisor-store/message-sheet';
...
const columns = [
  	{
		 name: 'messageSheetType',
		 label: '訊息傳送頁籤類別',
		 align: 'left',
		 field: 'messageSheetType',
		 sortable: true,
	},
	{
		 name: 'messageSheetID',
		 label: '訊息傳送頁籤代碼',
		 align: 'left',
		 field: 'messageSheetID',
		 sortable: true,
	},
	{
		 name: 'messageSheetName',
		 label: '訊息傳送頁籤名稱',
		 align: 'left',
		 field: 'messageSheetName',
		 sortable: true,
	},
	{
		 name: 'displayOrder',
...
export default {
  ...
  setup() {
    ...
    const moduleName = 'messageSheet';
    !store.hasModule(`${moduleName}`) && store.registerModule(`${moduleName}`, messageSheet);
    ...
    const filterItemOptions = [
      {
		 label: '訊息傳送頁籤類別',
		 value: 'MessageSheetType',
		 placeholder: '請輸入訊息傳送頁籤類別',
},
{
		 label: '訊息傳送頁籤代碼',
		 value: 'MessageSheetID',
		 placeholder: '請輸入訊息傳送頁籤代碼',
},
{
		 label: '訊息傳送頁籤名稱',
		 value: 'MessageSheetName',
		 placeholder: '請輸入訊息傳送頁籤名稱',
},
    ];
