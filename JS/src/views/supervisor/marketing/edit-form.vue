      ...
      <q-form @submit="onSubmitForm" class="q-gutter-md">
        ...
        <q-card-section style="max-height: 50vh" class="scroll">
            ...
            <q-input
                class="col"
                type="text"
                v-model.trim="formData.marketingID"
                label="* 行銷方案代碼"
                lazy-rules
            ...
            <q-input
                class="col"
                type="text"
                v-model.trim="formData.marketingType"
                label="* 行銷方案類別"
                lazy-rules
            ...
            <q-input
                class="col"
                type="text"
                v-model.trim="formData.marketingName"
                label="* 行銷方案名稱"
                lazy-rules
            ...
            <q-input
                class="col"
                type="text"
                v-model.trim="formData.marketingScript"
                label=" 行銷方案話術"
                lazy-rules
                :rules="[useRequiredInput, (val) => useMaxLength(val, 2000)]"
            /><q-input v-model="formData.marketingBegintDT" mask="date" :rules="['date']">
                <template v-slot:append>
                  <q-icon name="event" class="cursor-pointer">
                    ...
                    >
                      <q-date v-model="formData.marketingBegintDT">
            ...
            <div class="row q-col-gutter-md"><q-input v-model="formData.marketingEndDT" mask="date" :rules="['date']">
                <template v-slot:append>
                  <q-icon name="event" class="cursor-pointer">
                    <q-popup-proxy
                      ref="qDateProxy"
                      ...
                      transition-hide="scale"
                    >
                      <q-date v-model="formData.marketingEndDT">
                        <div class="row items-center justify-end">
                          <q-btn v-close-popup label="Close" color="primary" flat />
                        </div>
                      </q-date>
            ...
            <q-input
                class="col"
                type="text"
                v-model.trim="formData.offerCode"
                label=" 專案識別碼"
                lazy-rules
                :rules="[useRequiredInput, (val) => useMaxLength(val, 20)]"
            />
