...
import marketing from '@supervisor-store/marketing';
...
const columns = [
	...
	},
	{
		 ...
		 label: '行銷方案話術',
		 align: 'left',
		 field: 'marketingScript',
		 sortable: true,
	},
	{
		 name: 'marketingBegintDT',
		 label: '開始日期',
		 align: 'left',
		 field: 'marketingBegintDT',
		 sortable: true,
	},
	{
		 name: 'marketingEndDT',
...
export default {
  ...
  setup() {
    ...
    !store.hasModule(`${moduleName}`) && store.registerModule(`${moduleName}`, marketing);
...
},
{
		 label: '行銷方案類別',
		 value: 'MarketingType',
		 placeholder: '請輸入行銷方案類別',
},
{
		 label: '行銷方案名稱',
		 value: 'MarketingName',
		 placeholder: '請輸入行銷方案名稱',
},
    ];
