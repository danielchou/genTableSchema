...
import reasonTxn from '@supervisor-store/reason-txn';
...
export default {
  ...
  setup() {
    ...
    const moduleName = 'reasonTxn';
    !store.hasModule(`${moduleName}`) && store.registerModule(`${moduleName}`, reasonTxn);
