...
import user from '@supervisor-store/user';
...
const columns = [
	...
	{
		 name: 'employedStatusCode',
		 label: '在職狀態代碼',
		 align: 'left',
		 field: 'employedStatusCode',
		 sortable: true,
	},
	{
		 name: 'b08Code1',
...
export default {
  ...
  setup() {
    ...
    !store.hasModule(`${moduleName}`) && store.registerModule(`${moduleName}`, user);
