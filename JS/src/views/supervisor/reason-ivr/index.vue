...
import reasonIvr from '@supervisor-store/reason-ivr';
...
export default {
  ...
  setup() {
    ...
    const moduleName = 'reasonIvr';
    !store.hasModule(`${moduleName}`) && store.registerModule(`${moduleName}`, reasonIvr);
