...
import reason from '@supervisor-store/reason';
...
export default {
  ...
  setup() {
    ...
    !store.hasModule(`${moduleName}`) && store.registerModule(`${moduleName}`, reason);
    ...
    const filterItemOptions = [
      {
		 label: '聯繫原因碼代碼',
		 value: 'ReasonID',
		 placeholder: '請輸入聯繫原因碼代碼',
},
{
		 label: '聯繫原因碼名稱',
		 value: 'ReasonName',
		 placeholder: '請輸入聯繫原因碼名稱',
},
{
		 label: '上層聯繫原因碼代碼',
		 value: 'ParentReasonID',
		 placeholder: '請輸入上層聯繫原因碼代碼',
},
{
		 label: '階層',
		 value: 'Level',
