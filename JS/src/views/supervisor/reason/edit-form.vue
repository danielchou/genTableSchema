      ...
      <q-form @submit="onSubmitForm" class="q-gutter-md">
        ...
        <q-card-section style="max-height: 50vh" class="scroll">
            ...
            <q-input
                class="col"
                type="text"
                v-model.trim="formData.reasonID"
                label="* 聯繫原因碼代碼"
                lazy-rules
            ...
            <q-input
                class="col"
                type="text"
                v-model.trim="formData.reasonName"
                label="* 聯繫原因碼名稱"
                lazy-rules
            ...
            <q-input
                class="col"
                type="text"
                v-model.trim="formData.parentReasonID"
                label="* 上層聯繫原因碼代碼"
                lazy-rules
                :rules="[useRequiredInput, (val) => useMaxLength(val, 20)]"
            />
            ...
            <q-input
                class="col"
                type="text"
                v-model.trim="formData.bussinessUnit"
                label=" 事業處"
                lazy-rules
                :rules="[useRequiredInput, (val) => useMaxLength(val, 3)]"
            />
            <q-input
                class="col"
                type="text"
                v-model.trim="formData.bussinessB03Type"
                label=" B03業務別"
                lazy-rules
                :rules="[useRequiredInput, (val) => useMaxLength(val, 3)]"
            />
            ...
            <q-input
                class="col"
                type="text"
                v-model.trim="formData.reviewType"
                label=" 覆核類別"
                lazy-rules
                :rules="[useRequiredInput, (val) => useMaxLength(val, 3)]"
            />
            ...
            <q-input
                class="col"
                type="text"
                v-model.trim="formData.usuallyReasonName"
                label=" 常用名稱"
                lazy-rules
                :rules="[useRequiredInput, (val) => useMaxLength(val, 50)]"
            />
