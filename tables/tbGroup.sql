...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'群組ID' ,@level0type=N'SCHEMA',@level0name=N'agdSet', @level1type=N'TABLE',@level1name=N'tbGroup', @level2type=N'COLUMN',@level2name=N'GroupId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'是否啟用?' ,@level0type=N'SCHEMA',@level0name=N'agdSet', @level1type=N'TABLE',@level1name=N'tbGroup', @level2type=N'COLUMN',@level2name=N'IsEnable'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'異動者' ,@level0type=N'SCHEMA',@level0name=N'agdSet', @level1type=N'TABLE',@level1name=N'tbGroup', @level2type=N'COLUMN',@level2name=N'Updator'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'異動時間' ,@level0type=N'SCHEMA',@level0name=N'agdSet', @level1type=N'TABLE',@level1name=N'tbGroup', @level2type=N'COLUMN',@level2name=N'UpdateDt'
GO
